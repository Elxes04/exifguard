 ...
 */
export function profileToDatabaseRecord(profile) {
    return {
        id: profile.id,
 ...
 */
export function databaseRecordToProfile(record) {
    return {
        id: record.id,
 ...
 */
export function searchProfiles(profiles, query, categoryFilter = 'All') {
